...
namespace Persistence.Migrations
{
    ...
    [Migration("20241216024555_AddBookingTablesMigration")]
    partial class AddBookingTablesMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.HotelRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Book", b =>
                {
                    b.HasOne("Domain.HotelRoom", "HotelRoom")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Contact", b =>
                {
                    b.HasOne("Domain.Book", "Book")
                        .WithOne("Contact")
                        .HasForeignKey("Domain.Contact", "BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
